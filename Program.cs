...
namespace MethodMoreExercise4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CheckLenghtOfCoordinates(x1, y1, x2, y2, x3, y3, x4, y4);
            Console.ReadLine();

        }

        static void CheckLenghtOfCoordinates(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4)
        {
